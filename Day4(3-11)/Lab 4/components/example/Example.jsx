...
class Example extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      inputValue: '',
      buttonWasClicked: '',
      motto: 'This famous Latin phrase means “out of many, one.” It was the motto of the United States until 1956, when the motto was changed to “in God we trust.” This was just 2 years after the words “under God” were added to the Pledge of Allegiance. Many people still prefer the old motto because it expresses a message of pluralism, but so far there is no sign that the motto will change in the near future.'
    };
    ...
    return (
      <div className="container Example">
       ...
       <label htmlFor="inId">Input Field:
          ...
          <input id="inId" type="text" value={this.state.motto} onChange={this.setMototo} />
       </div>
        <p>
